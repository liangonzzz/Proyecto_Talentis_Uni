...
async function iniciarSesion(): Promise<void> {
  ...
  try {
    ...
    const rutas: Record<string, string> = {
      admin:     '/src/infrastructure/ui/core/shell.html',
      empleado:  '/src/infrastructure/ui/core/shell.html',
      candidato: '/src/infrastructure/ui/core/shell.html',
      // jefe: pendiente para siguiente sprint
    };
